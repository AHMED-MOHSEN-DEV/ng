...
import 'package:ramy/widgets/video.dart';
import '../../constants/app_colors.dart';

class QasrAlshawqChapters extends StatelessWidget {
  const QasrAlshawqChapters({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final chapters = [
      {'title': 'الفصل الأول', 'subtitle': 'بعد الثورة', 'number': '١'},
      {'title': 'الفصل الثاني', 'subtitle': 'كمال وعايدة', 'number': '٢'},
      {'title': 'الفصل الثالث', 'subtitle': 'الحب والفلسفة', 'number': '٣'},
      {'title': 'الفصل الرابع', 'subtitle': 'التغيرات الاجتماعية', 'number': '٤'},
      {'title': 'الفصل الخامس', 'subtitle': 'الصراع الداخلي', 'number': '٥'},
      {'title': 'الفصل السادس', 'subtitle': 'نهاية عهد', 'number': '٦'},
    ];

    return _buildChapterScreen(
      context,
      'قصر الشوق',
      'assets/books/2asrsho2.jpg',
